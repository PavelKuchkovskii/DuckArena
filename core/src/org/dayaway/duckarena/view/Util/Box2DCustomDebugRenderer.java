package org.dayaway.duckarena.view.Util;
...
public class Box2DCustomDebugRenderer implements Disposable {

    /** the immediate mode renderer to output our debug drawings **/
    protected ShapeRenderer renderer;

    /** vertices for polygon rendering **/
    private final static Vector2[] vertices = new Vector2[10000];
    ...
    public Box2DCustomDebugRenderer () {
        this(true, true, false, true, false, true);
    }

    public Box2DCustomDebugRenderer (boolean drawBodies, boolean drawJoints, boolean drawAABBs, boolean drawInactiveBodies,
    ...
    public static void setAxis (Vector2 axis) {
        Box2DCustomDebugRenderer.axis = axis;
    }
